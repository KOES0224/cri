...
export default async function SuccessPage() {
  ...
  const curated = curatedSuccessStories.map((story) => ({
    ...story,
    ...
    <div className="bg-[#FAFAFA] min-h-screen pt-32 pb-32">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {allStories.map((student: { id: string; slug: string; name: string; imageUrl: string | null; university: string; major: string; projectTitle: string; externalLink: string | null }, i: number) => (
